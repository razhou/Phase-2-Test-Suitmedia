...
struct ModelScreenThree {
    ...
    static let longitude:[Double] = [106.808942,106.8077469,106.80969399999999,106.8150897]
    static let latitude:[Double] = [ -6.2146330000000001,-6.212977886,-6.215986,-6.2170706610000002]
}
